...
export class DashboardComponent implements OnInit {
  ...
  colors: string[] = ['red', 'yellow', 'green', 'blue', 'purple', 'charcoal'];
  ...
  ngAfterViewInit() {
    ...
    // since the icons are dynamically added to the template,
    // this should be called after the view init
    AJS.$('[title]').tooltip();
  ...
  ngOnInit() {
    ...
    this.table = new AJS.RestfulTable({
      ...
      autoFocus: true,
      resources: {
        all: "/jira/rest/heroes/1.0/heroes",
        self: "/jira/rest/heroes/1.0/heroes"
      },
